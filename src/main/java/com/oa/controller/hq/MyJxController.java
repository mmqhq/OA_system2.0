...
public class MyJxController {
	...
	public @ResponseBody Map<String,Object>  findKhExamprojectList(){
	...
	public @ResponseBody Map<String,Object>  findKhLevelList(){
		return leService.findOaLevel();
	}
	/**
	 * 新增'考核项目'
	 * @return
