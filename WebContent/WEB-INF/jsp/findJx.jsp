	  ...
	  var table = layui.table;
	   table.render({
		    ...
		    ,url: 'find_jx_list'
		     ,page: true 
		    ,cols: [[
		      {field: 'name', title: '人员名称', width:130,align: 'center'}
		      ,{field: 'issue', title: '期次', width:100,align: 'center'}
		      ,{field: 'levelName', title: '考核等级', width:130,align: 'center'} 
		      ,{field: 'allScore', title: '总评分', width: 130,align: 'center'}
		      ,{field: 'projectScore', title: '考核项目得分', width: 130,align: 'center'}
